...
import honghu.com.test.MainActivity;
...
//		imgGridView.setOnItemClickListener(this);
    ...
    public ImageView iconImage(String filepath, int index, CheckBox checkBox) throws FileNotFoundException {
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(relativeLayout2.getMeasuredHeight() - 10, relativeLayout2.getMeasuredHeight() - 10);
